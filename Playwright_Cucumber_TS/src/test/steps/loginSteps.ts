...
import {mockBaseClass} from "../../helper/mock/mockData"

setDefaultTimeout(60 * 1000 * 2)

When('User mock {string} api with {string} data', async function (apiName,testDataFileName) {
    mockBaseClass.mockBrowserApi(apiName,testDataFileName);
    fixture.logger.info("Mocked Browser Api"+apiName);
});
